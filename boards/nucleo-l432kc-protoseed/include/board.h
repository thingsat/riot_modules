...
#include "../../nucleo-l432kc-protoseed/include/periph_conf.h"
...
// On board MCP9808 temperature sensor (MCP9808 sensor is a JC42 compatible temperature sensor)
...
/*
On board accelerometer and magnetometer
https://www.st.com/resource/en/datasheet/lsm303agr.pdf
#define LSM303AGRTR_ACC_I2C_ADDR_READ 				(0x32)
#define LSM303AGRTR_ACC_I2C_ADDR_WRITE 				(0x31)
#define LSM303AGRTR_MAG_I2C_ADDR_READ 				(0x3C)
#define LSM303AGRTR_MAG_I2C_ADDR_WRITE 				(0x3B)
*/
#define LSM303AGRTR_MAG_INT_PIN 				ARDUINO_PIN_8
