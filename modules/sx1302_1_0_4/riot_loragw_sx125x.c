...
//static const char *TAG = "LGW_SX125x";
...
/*
     esp32_loragw_sx125x.c:289:16: error: 'r' may be used uninitialized in this function [-Werror=maybe-uninitialized]
