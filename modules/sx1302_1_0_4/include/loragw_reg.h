...
/**
@brief LoRa concentrator memory address burst write
@param mem_addr memory address TODO
@param data pointer to byte array that will be sent to the LoRa concentrator
@param size size of the transfer, in byte(s)
@return status of register operation (LGW_REG_SUCCESS/LGW_REG_ERROR)
*/
...
/**
@brief LoRa concentrator memory address burst read
@param mem_addr memory address TODO
@param data pointer to byte array that will be written from the LoRa concentrator
@param size size of the transfer, in byte(s)
@return status of register operation (LGW_REG_SUCCESS/LGW_REG_ERROR)
...
/**
@brief LoRa concentrator memory address burst read and check on the flight
@param mem_addr memory address TODO
@param data_to_check pointer to byte array that will be compare with the data readen from the LoRa concentrator
@param size size of the transfer, in byte(s)
@return status of register operation (LGW_REG_SUCCESS/LGW_REG_ERROR)
*/
