...
typedef struct lgw_pkt_rx_s  lgw_pkt_rx_s_t;
...
typedef struct lgw_pkt_tx_s  lgw_pkt_tx_s_t;
...
#if ENABLE_REGTEST == 1
/**
@brief Connect to the LoRa concentrator, reset it and configure it quickly for the reg test
@return LGW_HAL_ERROR id the operation failed, LGW_HAL_SUCCESS else
*/
...
/**
@brief Return time on air of given parameters, in milliseconds
@param TODO
@return the packet time on air in milliseconds
*/
