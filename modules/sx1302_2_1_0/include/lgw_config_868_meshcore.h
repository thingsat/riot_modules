...
#ifndef _LGW_CONFIG_868_MESHCORE_H
#define _LGW_CONFIG_868_MESHCORE_H
...
MeshCore EU/UK "classic" community preset : 869.525 MHz, BW 250 kHz, SF11, CR 4/5, syncword 0x12
The MeshCore channel is received on the LoRa Service channel (channel 8) : fb + 62500 Hz = 869.525 MHz, BW 250 kHz, SF 11.

Nota Bene: the SX1302/SX1303 concentrator cannot demodulate 62.5 kHz LoRa :
the newer EU preset (869.618 MHz, BW 62.5 kHz, SF8) is NOT supported (only BW 125/250/500 kHz).
The Multi-SF channels (BW 125 kHz) remain on the LoRaWAN EU868 plan for private-syncword LoRa endpoints.
*/
