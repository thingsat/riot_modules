...
} __attribute__((packed)) MeshLoRa_MHDR;
...
} __attribute__((packed)) MeshLoRa_Uplink;
...
} __attribute__((packed)) MeshLoRa_Downlink;
...
} __attribute__((packed)) MeshLoRa_RelayHeartbeat;
