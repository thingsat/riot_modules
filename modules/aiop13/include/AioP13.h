...
#define radians(d)    (0.0174532925*d)
#define degrees(r)    (r/0.0174532925)
...
public:
	...
	P13Predict(const char *p_ccSatName, const char *p_ccl1, const char *p_ccl2);
    ~P13Predict();

    void predict(const int p_iyear, const int p_imonth, const int p_iday, const int p_ih, const int p_im, int p_is);
    void latlon(double &p_dlat, double &p_dlon);
};
