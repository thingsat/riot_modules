...
#ifdef PATCH_AYMERIC
#ifndef SHELL_EXTENDED_BUFFSIZE
#define SHELL_EXTENDED_BUFFSIZE (SHELL_DEFAULT_BUFSIZE * 4)
#endif

static char line_buf[SHELL_EXTENDED_BUFFSIZE];

int main(void)
{
    puts("RIOT lwip test application");
    shell_run(shell_commands, line_buf, SHELL_EXTENDED_BUFFSIZE);
